...
<body>
    ...
    <div class="creation bg-black text-light">
        ...
        <form class="bg-black text-light" action=""> <!--Aqui va el script php-->


              <!--ingresa la nueva descripcion del usuario-->
              <div class="form-group mb-3">
                <label for="user-description" class="form-label">Description</label>
                <textarea class="form-control" name="user-description" id="user-description" rows="3" required></textarea> <!--retorna la descripcion del usuario-->
              </div>
              ...
              <div class="form-group mb-3">
                ...
                <input class="form-control form-control-sm" name="user-pic" id="user-pic" type="file" required> <!--retorna la foto del usuario-->
              </div>
