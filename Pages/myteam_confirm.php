        ...
        <form class="" action="../Pages/projectpage.php">
            <div class="form-group text-center">
              ...
              <div class="form-group mb-3 text-center">
                <label for="team-code" name="team-code" class="form-label"><h2>TI0001</h2></label> <!--este label se va a modificar con el team code-->
                <h6>Share this code to your mates to join them to the team.</h6>
              </div>
            
            <a href="../Pages/myteam.html" class="btn btn-primary w-100">Next</a>
