<?php
    ...
    try{
        ...
        //Insert en la tabla
        $query=$conn->prepare("INSERT INTO user(Username, user_email, user_password, id_type_user, id_group, id_team, active, created_at, updated_at) VALUES (?,?,?,1,?, 'null', 1, now(), now()");
